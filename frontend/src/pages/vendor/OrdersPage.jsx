...
import { BoxIcon, PinIcon, ChatIcon } from "../../components/icons/Icons";
    ...
    <div className="card-dark border border-white/[0.06] rounded-2xl overflow-hidden">
      ...
      >
        ...
        <div className="text-right shrink-0">
          <p className="font-heading font-bold text-orange-400 text-sm">
      ...
      {expanded && (
        <div className="border-t border-white/[0.06] p-4 space-y-4">
          ...
          <div className="bg-white/[0.02] rounded-xl p-3">
            <p className="font-heading text-white/40 text-xs uppercase tracking-wide mb-2">
              Customer
            </p>
            ...
            <p className="font-body text-white/50 text-xs mt-0.5">
              <PinIcon className="inline-block w-4 h-4 mr-1" />
              {order.customer.address}
            </p>
            {order.customer.notes && (
              <p className="font-body text-yellow-400/70 text-xs mt-1">
                <ChatIcon className="inline-block w-4 h-4 mr-1" />
                {order.customer.notes}
              </p>
            )}
          </div>
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="font-heading text-white/40">
            No {filter !== "ALL" ? filter.replace(/_/g, " ").toLowerCase() : ""}{" "}
            orders
          </p>
        </div>
      ) : (
