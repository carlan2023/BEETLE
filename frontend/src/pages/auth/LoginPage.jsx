...
import { Eye, EyeOff, Package, Bell, BarChart2, Settings } from "lucide-react";
      ...
      >
        ...
        <div className="relative text-center">
          ...
          <div className="mt-12 space-y-4 text-left max-w-xs">
            {[
              { Icon: Package, text: "Manage your product listings" },
              { Icon: Bell, text: "Receive and process orders" },
              { Icon: BarChart2, text: "Track your sales and revenue" },
              { Icon: Settings, text: "Control your store settings" },
            ].map((i) => (
              <div
                key={i.text}
