...
export default function VendorLayout() {
  ...
  const statusColors = { approved: 'badge-green', pending: 'badge-yellow', suspended: 'badge-red' }
      ...
      <div className="px-6 py-4 border-b border-white/[0.06]">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="font-heading font-bold text-white text-sm truncate">{vendor?.businessName}</p>
        ...
        {vendor?.status === 'pending' && (
          <div className="mt-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-2.5 text-xs font-body text-yellow-400/80">
            ⏳ Account under review. We'll email you within 24hrs.
          </div>
        )}
      </div>
    ...
    <div className="flex h-screen bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-[#0D0D0D] border-b border-white/[0.06]">
          ...
          <span className="font-display text-xl text-white tracking-wider">BEETLE</span>
        </div>
